...
-- Synced live eBay listings (Inventory API / Sell API). Keyed by SKU so it can
-- link to our internal inventory catalog and act as a multi-channel source of truth.
